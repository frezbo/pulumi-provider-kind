...
func NewPatchJSON6902(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kind:PatchJSON6902:PatchJSON6902", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPatchJSON6902(ctx *pulumi.Context,
	...
	var resource PatchJSON6902
	err := ctx.ReadResource("kind:PatchJSON6902:PatchJSON6902", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
