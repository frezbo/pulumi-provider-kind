...
type PortMapping struct {
	...
	ContainerPort pulumi.IntPtrOutput    `pulumi:"containerPort"`
	HostPort      pulumi.IntPtrOutput    `pulumi:"hostPort"`
	ListenAddress pulumi.StringPtrOutput `pulumi:"listenAddress"`
...
func NewPortMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kind:PortMapping:PortMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPortMapping(ctx *pulumi.Context,
	...
	var resource PortMapping
	err := ctx.ReadResource("kind:PortMapping:PortMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
