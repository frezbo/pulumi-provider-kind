...
type Networking struct {
	...
	ApiServerAddress  pulumi.StringPtrOutput `pulumi:"apiServerAddress"`
	ApiServerPort     pulumi.IntPtrOutput    `pulumi:"apiServerPort"`
	DisableDefaultCNI pulumi.BoolPtrOutput   `pulumi:"disableDefaultCNI"`
	IpFamily          pulumi.StringPtrOutput `pulumi:"ipFamily"`
	KubeProxyMode     pulumi.StringPtrOutput `pulumi:"kubeProxyMode"`
	PodSubnet         pulumi.StringPtrOutput `pulumi:"podSubnet"`
...
func NewNetworking(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kind:Networking:Networking", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworking(ctx *pulumi.Context,
	...
	var resource Networking
	err := ctx.ReadResource("kind:Networking:Networking", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
