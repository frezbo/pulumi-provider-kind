...
type Node struct {
	...
	ExtraMounts                  mount.MountTypeArrayOutput                 `pulumi:"extraMounts"`
	ExtraPortMappings            portmapping.PortMappingTypeArrayOutput     `pulumi:"extraPortMappings"`
...
func NewNode(ctx *pulumi.Context,
	...
	var resource Node
	err := ctx.RegisterResource("kind:Node:Node", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNode(ctx *pulumi.Context,
	...
	var resource Node
	err := ctx.ReadResource("kind:Node:Node", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type NodeState struct {
	ExtraMounts                  mount.MountTypeArrayInput
	ExtraPortMappings            portmapping.PortMappingTypeArrayInput
